...
"""
loss year tiff must be in place 10 2nd tiff
"""
        ...
        for key in rgbs.keys():
            ...
            for tiff in range(len(tiff_objs)):
                ...
                for k in range(len(tiff_data[tiff])):
                    if tiff == 9 and tiff_data[tiff][k][row2][col2] >= 17:
                        rgbs[key].append(0)
...
if __name__ == "__main__":
    ...
    lossyear2020 = "data\\2013\Hansen_GFC-2020-v1.8_lossyear_50N_130W.tif"
    ...
    get_numpy_from_tiffs([sev3_fp],[rgb3_fp],[treecover, lossyear2020, slope, elevation, aspect, stream_distance, stand_age, stand_age_80, stand_age_200],False)
